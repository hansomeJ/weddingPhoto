...
class Cameraman(models.Model):
    ...
    ca_pwd = models.CharField(max_length=20, verbose_name='密码')
    ca_detail = models.TextField(verbose_name='简介')
    ca_image = models.ImageField(upload_to='static/img/cameraman', default='default_ca.jpg', verbose_name='摄影师照片')
