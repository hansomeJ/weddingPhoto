...
from myAdmin.models import Bridal_Veil
...
class Order(models.Model):
    ...
    order_bv = models.ManyToManyField(Bridal_Veil, verbose_name='订单中的婚纱')
    ...
    order_selectTime = models.DateTimeField(null=True, verbose_name='选片时间')
    order_getTime = models.DateTimeField(null=True, verbose_name='取片时间')
    order_space = models.ForeignKey(to=Space, to_field='id', null=True, on_delete=models.SET_NULL, verbose_name='场地')
    order_cameraman = models.ForeignKey(to=Cameraman, to_field='id', null=True, on_delete=models.SET_NULL,
                                        verbose_name='摄影师')
    order_moneyNum = models.IntegerField(null=True, verbose_name='订单总价')
    order_starTime = models.DateTimeField(auto_now_add=True, verbose_name='订单开始时间')
    order_endTime = models.DateTimeField(null=True, verbose_name='订单结束时间')
